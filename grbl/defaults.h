...
#ifdef DEFAULTS_MAKERFR_RCNC
  // Grbl generic default settings. Should work across different machines.
  #define DEFAULT_X_STEPS_PER_MM 2560.0
  #define DEFAULT_Y_STEPS_PER_MM 240.0
  #define DEFAULT_Z_STEPS_PER_MM 2560.0
  #define DEFAULT_X_MAX_RATE 15.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 180.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 6.0 // mm/min
